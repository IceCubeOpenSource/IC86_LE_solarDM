...
masschan = [(5,11),(10, 11), (20, 11), (35, 11), (50, 11), (100, 11)]
...
file = TFile("/data/user/mnisa/SolarDM/wimpsim_fluxes/wimpsim_fluxes.root")
...
file = TFile(out+"1D_signal_histograms_ch11_"+str(n_bins)+"bins.root","RECREATE")
